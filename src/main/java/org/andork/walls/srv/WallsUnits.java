...
public final class WallsUnits {
	...
	static final class Data implements Cloneable {
		...
		List<CtMeasurement> ctOrder =
			Arrays.asList(CtMeasurement.DISTANCE, CtMeasurement.AZIMUTH, CtMeasurement.INCLINATION);
		List<RectMeasurement> rectOrder =
			Arrays.asList(RectMeasurement.EAST, RectMeasurement.NORTH, RectMeasurement.UP);
		...
		UnitizedDouble<Angle> decl = Angle.degrees(0);
		UnitizedDouble<Angle> grid = Angle.degrees(0);
		UnitizedDouble<Angle> rect = Angle.degrees(0);
		UnitizedDouble<Length> incd = Length.meters(0);
		UnitizedDouble<Angle> inca = Angle.degrees(0);
		UnitizedDouble<Angle> incab = Angle.degrees(0);
		UnitizedDouble<Angle> incv = Angle.degrees(0);
		UnitizedDouble<Angle> incvb = Angle.degrees(0);
		UnitizedDouble<Length> incs = Length.meters(0);
		UnitizedDouble<Length> inch = Length.meters(0);
		boolean typeabCorrected = false;
		UnitizedDouble<Angle> typeabTolerance = Angle.degrees(2);
		boolean typeabNoAverage = false;
		boolean typevbCorrected = false;
		UnitizedDouble<Angle> typevbTolerance = Angle.degrees(2);
		boolean typevbNoAverage = false;
		CaseType case_ = CaseType.MIXED;
		LrudType lrud = LrudType.FROM;
		List<LrudMeasurement> lrudOrder =
			Arrays.asList(LrudMeasurement.LEFT, LrudMeasurement.RIGHT, LrudMeasurement.UP, LrudMeasurement.DOWN);
		List<TapingMethodMeasurement> tape =
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			Data other = (Data) obj;
			if (!Objects.equals(vectorType, other.vectorType))
				return false;
			if (!Objects.equals(ctOrder, other.ctOrder))
				return false;
			if (!Objects.equals(rectOrder, other.rectOrder))
				return false;
			if (!Objects.equals(dUnit, other.dUnit))
				return false;
			if (!Objects.equals(sUnit, other.sUnit))
				return false;
			if (!Objects.equals(aUnit, other.aUnit))
				return false;
			if (!Objects.equals(abUnit, other.abUnit))
				return false;
			if (!Objects.equals(vUnit, other.vUnit))
				return false;
			if (!Objects.equals(vbUnit, other.vbUnit))
				return false;
			if (!Objects.equals(decl, other.decl))
				return false;
			if (!Objects.equals(grid, other.grid))
				return false;
			if (!Objects.equals(rect, other.rect))
				return false;
			if (!Objects.equals(incd, other.incd))
				return false;
			if (!Objects.equals(inca, other.inca))
				return false;
			if (!Objects.equals(incab, other.incab))
				return false;
			if (!Objects.equals(incv, other.incv))
				return false;
			if (!Objects.equals(incvb, other.incvb))
				return false;
			if (!Objects.equals(incs, other.incs))
				return false;
			if (!Objects.equals(inch, other.inch))
				return false;
			if (typeabCorrected != other.typeabCorrected)
				return false;
			if (!Objects.equals(typeabTolerance, other.typeabTolerance))
				return false;
			if (typeabNoAverage != other.typeabNoAverage)
				return false;
			if (typevbCorrected != other.typevbCorrected)
				return false;
			if (!Objects.equals(typevbTolerance, other.typevbTolerance))
				return false;
			if (typevbNoAverage != other.typevbNoAverage)
				return false;
			if (!Objects.equals(case_, other.case_))
				return false;
			if (!Objects.equals(lrud, other.lrud))
				return false;
			if (!Objects.equals(lrudOrder, other.lrudOrder))
				return false;
			if (!Objects.equals(tape, other.tape))
				return false;
			if (!Objects.equals(flag, other.flag))
				return false;
			if (!Objects.equals(prefix, other.prefix))
				return false;
			if (Double.doubleToLongBits(uvh) != Double.doubleToLongBits(other.uvh))
				return false;
			if (Double.doubleToLongBits(uvv) != Double.doubleToLongBits(other.uvv))
				return false;
			return true;
		}
	...
	/**
	 * @param mutator a {@link Consumer} that applies mutations to this
	 *                {@code WallsUnits}.
	 *
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code vectorType} is unchanged, or a copy
	 *         with the new {@code vectorType}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code ctOrder} is unchanged, or a copy
	 *         with the new {@code ctOrder}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code rectOrder} is unchanged, or a copy
	 *         with the new {@code rectOrder}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code dUnit} is unchanged, or a copy with
	 *         the new {@code dUnit}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code sUnit} is unchanged, or a copy with
	 *         the new {@code sUnit}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code aUnit} is unchanged, or a copy with
	 *         the new {@code aUnit}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code abUnit} is unchanged, or a copy
	 *         with the new {@code abUnit}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code vUnit} is unchanged, or a copy with
	 *         the new {@code vUnit}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code vbUnit} is unchanged, or a copy
	 *         with the new {@code vbUnit}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code decl} is unchanged, or a copy with
	 *         the new {@code decl}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code grid} is unchanged, or a copy with
	 *         the new {@code grid}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code rect} is unchanged, or a copy with
	 *         the new {@code rect}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code incd} is unchanged, or a copy with
	 *         the new {@code incd}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code inca} is unchanged, or a copy with
	 *         the new {@code inca}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code incab} is unchanged, or a copy with
	 *         the new {@code incab}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code incv} is unchanged, or a copy with
	 *         the new {@code incv}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code incvb} is unchanged, or a copy with
	 *         the new {@code incvb}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code incs} is unchanged, or a copy with
	 *         the new {@code incs}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code inch} is unchanged, or a copy with
	 *         the new {@code inch}.
	 */
	 ...
	 *                        corrected
	 * 
	 * @return this {@code WallsUnits} if {@code typeabCorrected} is unchanged, or a
	 *         copy with the new {@code typeabCorrected}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code typeabTolerance} is unchanged, or a
	 *         copy with the new {@code typeabTolerance}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code typeabNoAverage} is unchanged, or a
	 *         copy with the new {@code typeabNoAverage}.
	 */
	 ...
	 *                        corrected
	 * 
	 * @return this {@code WallsUnits} if {@code typevbCorrected} is unchanged, or a
	 *         copy with the new {@code typevbCorrected}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code typevbTolerance} is unchanged, or a
	 *         copy with the new {@code typevbTolerance}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code typevbNoAverage} is unchanged, or a
	 *         copy with the new {@code typevbNoAverage}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code case_} is unchanged, or a copy with
	 *         the new {@code case_}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code lrud} is unchanged, or a copy with
	 *         the new {@code lrud}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code lrudOrder} is unchanged, or a copy
	 *         with the new {@code lrudOrder}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code tape} is unchanged, or a copy with
	 *         the new {@code tape}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code flag} is unchanged, or a copy with
	 *         the new {@code flag}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code prefix} is unchanged, or a copy
	 *         with the new {@code prefix}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code uvh} is unchanged, or a copy with
	 *         the new {@code uvh}.
	 */
	 ...
	 * 
	 * @return this {@code WallsUnits} if {@code uvv} is unchanged, or a copy with
	 *         the new {@code uvv}.
	 */
